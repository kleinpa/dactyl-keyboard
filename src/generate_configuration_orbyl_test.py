...
shape_config = {
    ...
    # EXPERIMENTAL
    'separable_thumb':
    True,  #creates a separable thumb section with additional screws to hold it down.  Only attached at base.
    ##############################
    ...
    0,
    'wall_thickness':
    4.5,  # wall thickness parameter used on upper/mid stage of the wall
    ...
    14.0,
    'notch_width':
    5.0,  # If using notch, it is identical to undecut, but only locally by the switch clip
...
if __name__ == '__main__':
    ...
    def main(argv):
        with open(FLAGS.output, 'w') as json_file:
            json.dump(shape_config, json_file, indent=4)
